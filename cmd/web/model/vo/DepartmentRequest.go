...
type DepartmentRequest struct {
	...
	ParentId       int64              `gorm:"parent_id" json:"parent_id" form:"parent_id" uri:"parent_id" validate:"required"`      // 上级ID
	Status         int64              `gorm:"status" json:"status" form:"status" uri:"status" `                                     // 状态: 1 启用 0: 停用
	Remarks        string             `gorm:"remarks" json:"remarks" form:"remarks" uri:"remarks" `                                 // 备注                                               // 创建人
