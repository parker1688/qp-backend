...
type FcBetRecordUnsettled struct {
	BaseDos
...
func (FcBetRecordUnsettled) TableName() string {
	return "fc_bet_record_unsettled"
}

type FcBetRecordUnsettledExt struct {
	FcBetRecordUnsettled
	Merchant FcMerchant `json:"merchant" gorm:"foreignkey:MerchantCode;references:MerchantCode"`
}

type FcBetRecordUnsettledResp struct {
	FcBetRecordUnsettled
