...
type FcUserSiteNotify struct {
	BaseDos
	UserId       string             `gorm:"column:user_id" json:"user_id" form:"user_id" uri:"user_id" `
	NotifyId     string             `gorm:"column:notify_id" json:"notify_id" form:"notify_id" uri:"notify_id" `                      // 公告ID
...
func (FcUserSiteNotify) TableName() string {
	return "fc_user_site_notify"
}
