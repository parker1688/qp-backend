...
type FcUserReportMonth struct {
	...
	Month               string             `gorm:"column:month" json:"month" form:"month" uri:"month" `                                                                 // 月份
...
func (FcUserReportMonth) TableName() string {
	return "fc_user_report_month"
}
