...
type FcVipMonthGift struct {
	...
	Month            string             `gorm:"column:month" json:"month" form:"month" uri:"month" `                                                     // 月 2025-2年-月
	...
	BonusAmountIssue float64            `gorm:"column:bonus_amount_issue" json:"bonus_amount_issue" form:"bonus_amount_issue" uri:"bonus_amount_issue" ` // 领取奖金金额
...
func (FcVipMonthGift) TableName() string {
	return "fc_vip_month_gift"
}
