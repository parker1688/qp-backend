...
type VenueTTQP struct {
	VenueConfig conf.TTQP
}

func NewTTQP(venueConfig *conf.TTQP) IVenues {
	return &VenueTTQP{
		VenueConfig: *venueConfig,
	}
}

func (v VenueTTQP) CreateUser(request *VenueCreateUserRequest) *VenueResponse {
...
func (v VenueTTQP) GetUserBalance(request *VenueGetUserBalanceRequest) *VenueGetUserBalanceResponse {
...
func (v VenueTTQP) UpdateUserPassword(request *VenueUpdateUserPasswordRequest) *VenueResponse {
	panic("implement me")
}

func (v VenueTTQP) GetOrderNo() string {
	//TODO implement me
	return tool.MakeTransferrder()
}

// 转入
func (v VenueTTQP) Deposit(request *VenueDepositRequest) *VenueDepositResponse {
...
// 转出
func (v VenueTTQP) Withdraw(request *VenueWithdrawRequest) *VenueWithdrawResponse {
...
func (v VenueTTQP) LoginGame(request *VenueLoginGameRequest) *VenueLoginGameResponse {
...
func (v VenueTTQP) TransferConfirm(request *VenueTransferConfirmRequest) *VenueResponse {
	venueResp := VenueResponse{}
	venueResp.Code = TransferConfirm_SUCCESS_CODE
	return &venueResp
}
func (v VenueTTQP) PullOrder(request *VenuePullOrderRequest) *VenuePullOrderResponse {
	//TODO implement me
	panic("implement me")
}

func (v VenueTTQP) CallBackConfirm(request *VenueCallBackConfirmRequest) *VenueResponse {
	//TODO implement me
	panic("implement me")
}

func (v VenueTTQP) AmountLimitFix(amount float64, currency string) float64 {
	//TODO implement me
	return amount
}
