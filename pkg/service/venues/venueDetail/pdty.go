...
type VenuePDTY struct {
	VenueConfig conf.PDTY
}

func NewPDTY(venueConfig *conf.PDTY) IVenues {
	return &VenuePDTY{
		VenueConfig: *venueConfig,
	}
}

func (v VenuePDTY) CreateUser(request *VenueCreateUserRequest) *VenueResponse {
...
func (v VenuePDTY) GetUserBalance(request *VenueGetUserBalanceRequest) *VenueGetUserBalanceResponse {
...
func (v VenuePDTY) UpdateUserPassword(request *VenueUpdateUserPasswordRequest) *VenueResponse {
	panic("implement me")
}

func (v VenuePDTY) GetOrderNo() string {
	//TODO implement me
	return tool.MakeTransferrder()
}

// 转入
func (v VenuePDTY) Deposit(request *VenueDepositRequest) *VenueDepositResponse {
...
// 转出
func (v VenuePDTY) Withdraw(request *VenueWithdrawRequest) *VenueWithdrawResponse {
...
func (v VenuePDTY) LoginGame(request *VenueLoginGameRequest) *VenueLoginGameResponse {
...
func (v VenuePDTY) TransferConfirm(request *VenueTransferConfirmRequest) *VenueResponse {
	venueResp := VenueResponse{}
	venueResp.Code = TransferConfirm_SUCCESS_CODE
	return &venueResp
}
func (v VenuePDTY) PullOrder(request *VenuePullOrderRequest) *VenuePullOrderResponse {
	//TODO implement me
	panic("implement me")
}

func (v VenuePDTY) CallBackConfirm(request *VenueCallBackConfirmRequest) *VenueResponse {
	//TODO implement me
	panic("implement me")
}

func (v VenuePDTY) AmountLimitFix(amount float64, currency string) float64 {
	//TODO implement me
	return amount
}
