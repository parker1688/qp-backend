...
type VenueSGDZ struct {
	VenueConfig conf.SGDZ
}

func NewSGDZ(venueConfig *conf.SGDZ) IVenues {
	return &VenueSGDZ{
		VenueConfig: *venueConfig,
	}
}

func (v VenueSGDZ) CreateUser(request *VenueCreateUserRequest) *VenueResponse {
...
func (v VenueSGDZ) GetUserBalance(request *VenueGetUserBalanceRequest) *VenueGetUserBalanceResponse {
...
func (v VenueSGDZ) UpdateUserPassword(request *VenueUpdateUserPasswordRequest) *VenueResponse {
	panic("implement me")
}

func (v VenueSGDZ) GetOrderNo() string {
	//TODO implement me
	return tool.MakeTransferrder()
}

// 转入
func (v VenueSGDZ) Deposit(request *VenueDepositRequest) *VenueDepositResponse {
...
// 转出
func (v VenueSGDZ) Withdraw(request *VenueWithdrawRequest) *VenueWithdrawResponse {
...
func (v VenueSGDZ) LoginGame(request *VenueLoginGameRequest) *VenueLoginGameResponse {
...
func (v VenueSGDZ) TransferConfirm(request *VenueTransferConfirmRequest) *VenueResponse {
	venueResp := VenueResponse{}
	venueResp.Code = TransferConfirm_SUCCESS_CODE
	return &venueResp
}
func (v VenueSGDZ) PullOrder(request *VenuePullOrderRequest) *VenuePullOrderResponse {
	//TODO implement me
	panic("implement me")
}

func (v VenueSGDZ) CallBackConfirm(request *VenueCallBackConfirmRequest) *VenueResponse {
	//TODO implement me
	panic("implement me")
}

func (v VenueSGDZ) AmountLimitFix(amount float64, currency string) float64 {
	//TODO implement me
	return amount
}
