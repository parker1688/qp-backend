...
type VenueLGDDZ struct {
	VenueConfig conf.LGDDZ
}

func NewLGDDZ(venueConfig *conf.LGDDZ) IVenues {
	return &VenueLGDDZ{
		VenueConfig: *venueConfig,
	}
}

func (v VenueLGDDZ) CreateUser(request *VenueCreateUserRequest) *VenueResponse {
...
func (v VenueLGDDZ) GetUserBalance(request *VenueGetUserBalanceRequest) *VenueGetUserBalanceResponse {
...
func (v VenueLGDDZ) UpdateUserPassword(request *VenueUpdateUserPasswordRequest) *VenueResponse {
	panic("implement me")
}

func (v VenueLGDDZ) GetOrderNo() string {
	//TODO implement me
	return tool.MakeTransferrder()
}

// 转入
func (v VenueLGDDZ) Deposit(request *VenueDepositRequest) *VenueDepositResponse {
...
// 转出
func (v VenueLGDDZ) Withdraw(request *VenueWithdrawRequest) *VenueWithdrawResponse {
...
func (v VenueLGDDZ) LoginGame(request *VenueLoginGameRequest) *VenueLoginGameResponse {
...
func (v VenueLGDDZ) TransferConfirm(request *VenueTransferConfirmRequest) *VenueResponse {
	venueResp := VenueResponse{}
	venueResp.Code = TransferConfirm_SUCCESS_CODE
	return &venueResp
}
func (v VenueLGDDZ) PullOrder(request *VenuePullOrderRequest) *VenuePullOrderResponse {
	//TODO implement me
	panic("implement me")
}

func (v VenueLGDDZ) CallBackConfirm(request *VenueCallBackConfirmRequest) *VenueResponse {
	//TODO implement me
	panic("implement me")
}

func (v VenueLGDDZ) AmountLimitFix(amount float64, currency string) float64 {
	//TODO implement me
	return amount
}
