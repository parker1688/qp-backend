...
type VenueJLDZ struct {
	VenueConfig conf.JLDZ
}

func NewJLDZ(venueConfig *conf.JLDZ) IVenues {
	return &VenueJLDZ{
		VenueConfig: *venueConfig,
	}
}

func (v VenueJLDZ) CreateUser(request *VenueCreateUserRequest) *VenueResponse {
...
func (v VenueJLDZ) GetUserBalance(request *VenueGetUserBalanceRequest) *VenueGetUserBalanceResponse {
...
func (v VenueJLDZ) UpdateUserPassword(request *VenueUpdateUserPasswordRequest) *VenueResponse {
	panic("implement me")
}

func (v VenueJLDZ) GetOrderNo() string {
	//TODO implement me
	return tool.MakeTransferrder()
}

// 转入
func (v VenueJLDZ) Deposit(request *VenueDepositRequest) *VenueDepositResponse {
...
// 转出
func (v VenueJLDZ) Withdraw(request *VenueWithdrawRequest) *VenueWithdrawResponse {
...
func (v VenueJLDZ) LoginGame(request *VenueLoginGameRequest) *VenueLoginGameResponse {
...
func (v VenueJLDZ) TransferConfirm(request *VenueTransferConfirmRequest) *VenueResponse {
	venueResp := VenueResponse{}
	venueResp.Code = TransferConfirm_SUCCESS_CODE
	return &venueResp
}
func (v VenueJLDZ) PullOrder(request *VenuePullOrderRequest) *VenuePullOrderResponse {
	//TODO implement me
	panic("implement me")
}

func (v VenueJLDZ) CallBackConfirm(request *VenueCallBackConfirmRequest) *VenueResponse {
	//TODO implement me
	panic("implement me")
}

func (v VenueJLDZ) AmountLimitFix(amount float64, currency string) float64 {
	//TODO implement me
	return amount
}
