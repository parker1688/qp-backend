...
type VenueIMTY struct {
	VenueConfig conf.IMTY
}

func NewIMTY(venueConfig *conf.IMTY) IVenues {
	return &VenueIMTY{
		VenueConfig: *venueConfig,
	}
}

func (v VenueIMTY) CreateUser(request *VenueCreateUserRequest) *VenueResponse {
...
func (v VenueIMTY) GetUserBalance(request *VenueGetUserBalanceRequest) *VenueGetUserBalanceResponse {
...
func (v VenueIMTY) UpdateUserPassword(request *VenueUpdateUserPasswordRequest) *VenueResponse {
	panic("implement me")
}

func (v VenueIMTY) GetOrderNo() string {
	//TODO implement me
	return tool.MakeTransferrder()
}

// 转入
func (v VenueIMTY) Deposit(request *VenueDepositRequest) *VenueDepositResponse {
...
// 转出
func (v VenueIMTY) Withdraw(request *VenueWithdrawRequest) *VenueWithdrawResponse {
...
func (v VenueIMTY) LoginGame(request *VenueLoginGameRequest) *VenueLoginGameResponse {
...
func (v VenueIMTY) TransferConfirm(request *VenueTransferConfirmRequest) *VenueResponse {
	venueResp := VenueResponse{}
	venueResp.Code = TransferConfirm_SUCCESS_CODE
	return &venueResp
}
func (v VenueIMTY) PullOrder(request *VenuePullOrderRequest) *VenuePullOrderResponse {
	//TODO implement me
	panic("implement me")
}

func (v VenueIMTY) CallBackConfirm(request *VenueCallBackConfirmRequest) *VenueResponse {
	//TODO implement me
	panic("implement me")
}

func (v VenueIMTY) AmountLimitFix(amount float64, currency string) float64 {
	//TODO implement me
	return amount
}
