...
type VenueMWDZ struct {
	VenueConfig conf.MWDZ
}

func NewMWDZ(venueConfig *conf.MWDZ) IVenues {
	return &VenueMWDZ{
		VenueConfig: *venueConfig,
	}
}

func (v VenueMWDZ) CreateUser(request *VenueCreateUserRequest) *VenueResponse {
...
func (v VenueMWDZ) GetUserBalance(request *VenueGetUserBalanceRequest) *VenueGetUserBalanceResponse {
...
func (v VenueMWDZ) UpdateUserPassword(request *VenueUpdateUserPasswordRequest) *VenueResponse {
	panic("implement me")
}

func (v VenueMWDZ) GetOrderNo() string {
	//TODO implement me
	return tool.MakeTransferrder()
}

// 转入
func (v VenueMWDZ) Deposit(request *VenueDepositRequest) *VenueDepositResponse {
...
// 转出
func (v VenueMWDZ) Withdraw(request *VenueWithdrawRequest) *VenueWithdrawResponse {
...
func (v VenueMWDZ) LoginGame(request *VenueLoginGameRequest) *VenueLoginGameResponse {
...
func (v VenueMWDZ) TransferConfirm(request *VenueTransferConfirmRequest) *VenueResponse {
	venueResp := VenueResponse{}
	venueResp.Code = TransferConfirm_SUCCESS_CODE
	return &venueResp
}
func (v VenueMWDZ) PullOrder(request *VenuePullOrderRequest) *VenuePullOrderResponse {
	//TODO implement me
	panic("implement me")
}

func (v VenueMWDZ) CallBackConfirm(request *VenueCallBackConfirmRequest) *VenueResponse {
	//TODO implement me
	panic("implement me")
}

func (v VenueMWDZ) AmountLimitFix(amount float64, currency string) float64 {
	//TODO implement me
	return amount
}
