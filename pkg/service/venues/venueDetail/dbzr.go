...
type VenueDBZR struct {
	VenueConfig conf.DBZR
}

func NewDBZR(venueConfig *conf.DBZR) IVenues {
	return &VenueDBZR{
		VenueConfig: *venueConfig,
	}
}

func (v VenueDBZR) CreateUser(request *VenueCreateUserRequest) *VenueResponse {
...
func (v VenueDBZR) GetUserBalance(request *VenueGetUserBalanceRequest) *VenueGetUserBalanceResponse {
...
func (v VenueDBZR) UpdateUserPassword(request *VenueUpdateUserPasswordRequest) *VenueResponse {
	panic("implement me")
}

func (v VenueDBZR) GetOrderNo() string {
	//TODO implement me
	return tool.MakeTransferrder()
}

// 转入
func (v VenueDBZR) Deposit(request *VenueDepositRequest) *VenueDepositResponse {
	...
	param := "UserID=" + request.UserName + "&Amount=" + tool.String(amount) + "&TraceId=" + traceId + "&" + appSecret
	sign := tool.MD5([]byte(param))
	reqMap := map[string]string{
		"UserID":  request.UserName,
		"Amount":  amount1,
...
// 转出
func (v VenueDBZR) Withdraw(request *VenueWithdrawRequest) *VenueWithdrawResponse {
...
func (v VenueDBZR) LoginGame(request *VenueLoginGameRequest) *VenueLoginGameResponse {
...
func (v VenueDBZR) TransferConfirm(request *VenueTransferConfirmRequest) *VenueResponse {
	venueResp := VenueResponse{}
	venueResp.Code = TransferConfirm_SUCCESS_CODE
	return &venueResp
}
func (v VenueDBZR) PullOrder(request *VenuePullOrderRequest) *VenuePullOrderResponse {
	//TODO implement me
	panic("implement me")
}

func (v VenueDBZR) CallBackConfirm(request *VenueCallBackConfirmRequest) *VenueResponse {
	//TODO implement me
	panic("implement me")
}

func (v VenueDBZR) AmountLimitFix(amount float64, currency string) float64 {
	//TODO implement me
	return amount
}
